...
const CRYPTO_MODELS_POOL: CryptoModel[] = [
...
function ChooseCryptoModel(){
    ...
    const [randomModel, setRandomModel] = useState<CryptoModel | null>(null);
        ...
        <Canvas camera={{position : [0,0,5], fov : 45}}>
            ...
            <Float rotationIntensity={1} floatIntensity={1} speed={1.5}>
                {randomModel.type === 'model' ? (
                    <CryptoModel3D modelPath={randomModel.path} scale={randomModel.scale ?? 1} />
                ) : (
